...
2. Models follow Farm → Project → Module hierarchy. LCA models under `lca/`, RothC under `rothc/`.
3. Reference tables (LcaFertilizer, LcaFuelType, LcaSeed, LcaDefensive) are pre-seeded, never user-editable.

Key files: `lca/models/`, `rothc/models.py`, `farms/models.py`, `projects/models.py`
