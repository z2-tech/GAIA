...
3. RothC calculations in `rothc/calculos/` — monthly decomposition with Open-Meteo climate data.
...
Key files: `lca/calculos/`, `rothc/calculos/`, `farms/services.py`, `projects/services.py`
