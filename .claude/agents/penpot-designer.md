...
tools: Read, Grep, Glob, Bash, Edit, Write, Skill, codegraph_*, mcp__penpot__high_level_overview, mcp__penpot__execute_code, mcp__penpot__export_shape, mcp__penpot__penpot_api_info
---

Read `.opencode/agents/penpot-designer.md`
