...
|----|--------|----------|--------|
| BE-01 | Rotas de edição, exclusão e clone do LCA | @Matheus Rodrigues | ⬜ Pendente |
| BE-02 | Rotas de edição, exclusão e clone do RothC | @Matheus Rodrigues | ⬜ Pendente |
| BE-03 | Suporte a múltiplos preenchimentos no Regenerativo | @léo bola | ⬜ Pendente |
| BE-04 | Rotas de exclusão e clone do Regenerativo | @léo bola | ⬜ Pendente |
| BE-05 | Desenvolvimento do módulo Biodiversidade (BAT) | @léo bola | ⬜ Pendente |
| BE-06 | Módulos preenchidos por talhão | @Matheus Rodrigues | ⬜ Pendente |
| BE-07 | Revalidar LCA com planilha EIQ | @Matheus Rodrigues | ⬜ Pendente |
| BE-08 | Fix RothC: adicionar coluna de fertilizantes | @Matheus Rodrigues | ⬜ Pendente |
| BE-09 | Fix: incluir "Perene" em Clima/Solo (LCA) | @léo bola | ⬜ Pendente |
| BE-10 | Status do projeto → concluído se 100% | @fernandocampana | ⬜ Pendente |
| BE-11 | Revalidar % de conclusão dos módulos | @fernandocampana | ⬜ Pendente |
...
| ID | Tarefa | Assignee | Status |
|----|--------|----------|--------|
| SHARED-01 | Discovery da tela Visão Geral do Projeto | @fernandocampana | ⬜ Pendente |
...
| ID | Tarefa | Assignee | Status |
|----|--------|----------|--------|
| BE-12 | Feature de comparação de módulos/fazendas/projetos | — | ⬜ Pendente |
| BE-13 | Mais opções de cultura no RothC | — | ⬜ Pendente |
